        ...
        <el-row>
            ...
            <el-col :span="2" style="text-align:center;">
                <div class="splitter">
                    <div id="buttons">
                        <div>
                            <el-button icon="el-icon-arrow-right" circle @click="handleRight()"></el-button>
                        </div>
                        <div style="margin:20px 0">
                            <el-button icon="el-icon-arrow-left" circle @click="handleLeft()"></el-button>
                        </div>
                    </div>
                </div>
            </el-col>
            <el-col :span="11">
                <div ref="treeEditor" class="editor"></div>
            </el-col>
        </el-row>
    </el-card>
</template>
...
export default {
  ...
  computed: {
    ...
    treeEditor() {
      return this.$refs.treeEditor;
    }    
  },
  methods: {
      handleLeft(){
          this.cEditor.set(this.jEditor.get());
      },
      handleRight(){
          this.jEditor.set(this.cEditor.get());
      }
  },
  mounted: function() {
    this.cEditor = new JSONEditor(this.codeEditor, {mode:'code',statusBar:false},this.json);

    this.jEditor = new JSONEditor(this.treeEditor, {mode:'tree'},this.json);
  }
};
</script>
...
div.jsoneditor-tree button,
table.jsoneditor-search button {
  background-image: url(//qn12.tool.lu/201801/13/104648ecOPSvh0VNewIb5c_x.svg);
} */
